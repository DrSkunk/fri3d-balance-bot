...
void setup(){
  ...
  //pinMode(32, OUTPUT);                                                       //Configure digital poort 2 as output
  //pinMode(25, OUTPUT);                                                       //Configure digital poort 3 as output
  //pinMode(26, OUTPUT);                                                       //Configure digital poort 4 as output
  //pinMode(37, OUTPUT);                                                       //Configure digital poort 5 as output
